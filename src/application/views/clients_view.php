...
<table class="easyui-datagrid" title="Clients"  style="width:auto;height:100%" id="grid_clients"
		...
		<thead>
         ...
         <th data-options="field:'password',width:80,sortable:true">Password</th>
         <th data-options="field:'status_id',width:80,sortable:true">Status_id</th>
         <th data-options="field:'node_id',width:80,sortable:true">Node_id</th>
         <th data-options="field:'phone',width:80,sortable:true">Phone</th>
         <th data-options="field:'verification_code',width:80,sortable:true">Verification_code</th>
         <th data-options="field:'init_date',width:80,sortable:true">Init_date</th>
         <th data-options="field:'last_access',width:80,sortable:true">Last_access</th>
         <th data-options="field:'utm_source',width:80,sortable:true">Utm_source</th>
         <th data-options="field:'utm_campain',width:80,sortable:true">Utm_campain</th>
	...
	<div style="padding:5px">
	    ...
	    <form id="form_clients" method="post">
         ...
         <tr><td>Email:</td><td><input class='easyui-validatebox' type='text' name='email' data-options='required:true'></input></td></tr>
         <tr><td>Password:</td><td><input class='easyui-validatebox' type='text' name='password' data-options='required:true'></input></td></tr>
         <tr><td>Status_id:</td><td><input class='easyui-validatebox' type='text' name='status_id' data-options='required:true'></input></td></tr>
         <tr><td>Node_id:</td><td><input class='easyui-validatebox' type='text' name='node_id' data-options='required:true'></input></td></tr>
         <tr><td>Phone:</td><td><input class='easyui-validatebox' type='text' name='phone' data-options='required:true'></input></td></tr>
         <tr><td>Verification_code:</td><td><input class='easyui-validatebox' type='text' name='verification_code' data-options='required:true'></input></td></tr>
         <tr><td>Init_date:</td><td><input class='easyui-validatebox' type='text' name='init_date' data-options='required:true'></input></td></tr>
         <tr><td>Last_access:</td><td><input class='easyui-validatebox' type='text' name='last_access' data-options='required:true'></input></td></tr>
         <tr><td>Utm_source:</td><td><input class='easyui-validatebox' type='text' name='utm_source' data-options='required:true'></input></td></tr>
         <tr><td>Utm_campain:</td><td><input class='easyui-validatebox' type='text' name='utm_campain' data-options='required:true'></input></td></tr>
